...
@Repository
public interface PostReactionRepository extends AuditingEntityRepository<PostReactionEntity> {
	long countByPostIdAndReactionType(String postId, PostReactionType reactionType);
